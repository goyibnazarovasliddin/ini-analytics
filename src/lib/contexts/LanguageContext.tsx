...
const translations: Record<Language, Record<string, string>> = {
  uz: {
    ...
    'methodology.yoyFormula': 'YoY (%) = [ (PriceLevel_t / PriceLevel_{t-12}) - 1 ] × 100',
    'methodology.yoyLegend': 'PriceLevel_t = Π (Index_i / 100). Davr 12 oyni o\'z ichiga oladi.',
  ...
  ru: {
    ...
    'methodology.yoyFormula': 'YoY (%) = [ (PriceLevel_t / PriceLevel_{t-12}) - 1 ] × 100',
    'methodology.yoyLegend': 'PriceLevel_t = Π (Index_i / 100). Период охватывает 12 месяцев.',
  ...
  en: {
    ...
    'methodology.yoyFormula': 'YoY (%) = [ (PriceLevel_t / PriceLevel_{t-12}) - 1 ] × 100',
    'methodology.yoyLegend': 'PriceLevel_t = Π (Index_i / 100). Period covers 12 months.',
